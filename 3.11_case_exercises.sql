...
SELECT e.emp_no, de.dept_no, e.hire_date, IF(s.to_date != '9999-01-01', MAX(s.to_date), s.to_date),
	IF(de.to_date = '9999-01-01' AND s.to_date = '9999-01-01', 1, 0) AS is_current_employee
FROM employees AS e
